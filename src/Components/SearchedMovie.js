...
export default function SearchedMovie() {
    ...
    useEffect(() => {
      const name = localStorage.getItem("searchedMovie")
      fetch(`https://api.themoviedb.org/3/search/movie?api_key=c45a857c193f6302f2b5061c3b85e743&language=en-US&query=${name}&page=`+page)
        .then((resp) => resp.json())
        .then((data) => {
          ...
          <div className="product-border">
            <div className="product-content">
              <div className="product-image">
                  <img
                    className="img-thumbnail product-image-border"
